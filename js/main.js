(() => {
    ...
    let prevScrollHeight = 0; // 현재 스크롤 위치 보다 이전 위치한 스크롤 섹션들의 스크롤 높이값의 합
    let currentScene = 0;
    ...
    const sceneInfo = [
        {
            //0
            type: 'sticky',
            heightNum: 5, // 브라우저 높이의 5배로 scrollHeight
            scrollHeight: 0,
            objs: {
        ...
        switch (currentScene) {
            ...
            case 3:
                ...
                if(!values.rectStartY){
                    ...
                    values.rect1X[2].end = values.rectStartY / canvasScaleRatio;
                    values.rect2X[2].end = values.rectStartY / canvasScaleRatio;
                }
